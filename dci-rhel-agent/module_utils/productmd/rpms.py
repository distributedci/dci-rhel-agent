...
from ansible.module_utils.productmd.common import Header
...
class Rpms(common.MetadataBase):
    def __init__(self):
    ...
    def _check_nevra(self, nevra):
        ...
        try:
            nevra_dict = common.parse_nvra(nevra)
        except ValueError:
    ...
    def add(self, variant, arch, nevra, path, sigkey, category, srpm_nevra=None):
        ...
        if arch not in common.RPM_ARCHES:
