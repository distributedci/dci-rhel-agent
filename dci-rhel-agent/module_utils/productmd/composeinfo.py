...
from ansible.module_utils.productmd.common import Header, RELEASE_VERSION_RE
...
class ComposeInfo(common.MetadataBase):
    """
...
def cmp_label(label1, label2):
    ...
    split_ver1 = common.split_version(ver1)
    split_ver2 = common.split_version(ver2)
    return cmp(split_ver1, split_ver2)


class Compose(common.MetadataBase):
    """
...
class BaseProduct(common.MetadataBase):
    ...
    def __cmp__(self, other):
        ...
        if self.version != other.version:
            return cmp(common.split_version(self.version), common.split_version(other.version))
        return 0
    ...
    def _validate_type(self):
        ...
        self._assert_value("type", common.RELEASE_TYPES)
...
class VariantBase(common.MetadataBase):
    def __init__(self, metadata):
