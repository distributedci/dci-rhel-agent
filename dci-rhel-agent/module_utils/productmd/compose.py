...
Example::
  ...
  import ansible.module_utils.productmd.compose
  compose = ansible.module_utils.productmd.compose.Compose("/path/to/compose")
...
import ansible.module_utils.productmd.composeinfo
import ansible.module_utils.productmd.images
import ansible.module_utils.productmd.rpms
import ansible.module_utils.productmd.modules
from ansible.module_utils.productmd.common import _file_exists
...
class Compose(object):
    ...
    def info(self):
        ...
        self._composeinfo = self._load_metadata(paths, ansible.module_utils.productmd.composeinfo.ComposeInfo)
        return self._composeinfo
    ...
    def images(self):
        ...
        self._images = self._load_metadata(paths, ansible.module_utils.productmd.images.Images)
        return self._images
    ...
    def rpms(self):
        ...
        self._rpms = self._load_metadata(paths, ansible.module_utils.productmd.rpms.Rpms)
        return self._rpms
    ...
    def modules(self):
        ...
        self._modules = self._load_metadata(paths, ansible.module_utils.productmd.modules.Modules)
        return self._modules
