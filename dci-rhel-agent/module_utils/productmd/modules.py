...
from ansible.module_utils.productmd.common import Header, RPM_ARCHES
from ansible.module_utils.productmd.composeinfo import Compose
from ansible.module_utils.productmd.rpms import SUPPORTED_CATEGORIES
...
class Modules(common.MetadataBase):
    def __init__(self):
